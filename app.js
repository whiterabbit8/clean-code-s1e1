...
var taskInput=document.querySelector('.task_type_add');//Add a new task.
var addButton=document.querySelector('.add-container .button');//first button
var incompleteTaskHolder=document.querySelector('.task-list_undone');//ul of #incompleteTasks
...
var createNewTaskElement=function(taskString){
    ...
    label.className='task task_type_label';

    //Each elements, needs appending
    checkBox.type='checkbox';
    checkBox.className='task-list__checkbox';
    editInput.type='text';
    editInput.className='task task_type_input';
    ...
    deleteButtonImg.className='button__remove-img';
...
var editTask=function(){
    ...
    var editInput=listItem.querySelector('.task_type_input');
    var label=listItem.querySelector('.task_type_label');
